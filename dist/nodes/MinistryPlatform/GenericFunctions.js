    ...
    try {
        ...
        if (isTokenExpired && !isRetry && error.response?.status === 500) {
            try {
                ...
                throw new n8n_workflow_1.NodeOperationError(this.getNode(), `OAuth2 token has expired and refresh failed: ${retryError.message}. Please reconnect your MinistryPlatform credentials in n8n.`, {
